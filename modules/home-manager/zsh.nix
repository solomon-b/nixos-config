...
[ $TERM = "dumb" ] && unsetopt zle && PS1='$ '
      ...
      function git-jump {
        REPO=$(fd -t d -d 3 . ${config.home.homeDirectory}/Development | sed -E 's|^${config.home.homeDirectory}/Development/||g' | fzf)
        [[ -n $REPO ]] && cd "${config.home.homeDirectory}/Development/''${REPO}"
      }

# Forklifted from https://github.com/NixOS/nixpkgs/pull/371458
# This module was copied directly from the upstream PR to use before it's
# merged into nixpkgs. Once available in nixpkgs, this file can be removed.
    ...
    services.lubelogger = {
      ...
      environmentFile = lib.mkOption {
        ...
        description = ''
          ...
          format. Refer to the documentation for supported options.
